...
namespace jcPimSoftware
{
    ...
    {
        private static int clsSunWave  = 0;
        
        private static int clsJointCom = 1;
        ...
        /// <summary>
        /// 设置地址为ComAddr的设备辅助GPO
        /// </summary>
        /// <param name="ComAddr"></param>
        /// <param name="priority"></param>
        /// <param name="value"></param>
        [DllImport("jcRFSignal.dll", CallingConvention = CallingConvention.StdCall, EntryPoint = "RFAssistGpo", CharSet = CharSet.Ansi)]
        public static extern void RFAssistGpo(int ComAddr,
                                         int priority,
                                         int value);
       ...
       /// <param name="?"></param>
        ...
        /// <summary>
        /// 设置地址为ComAddr的功放输出功率和中心频率，单位dBm、MHz,并指示RF延后50ms进行RFSample动作
        /// </summary>
        /// <param name="ComAddr"></param>
        /// <param name="priority"></param>
        /// <param name="p"></param>
        /// <param name="f"></param>
        [DllImport("jcRFSignal.dll", CallingConvention = CallingConvention.StdCall, EntryPoint = "RFPowerFreqSample")]
        public static extern void RFPowerFreqSample(int ComAddr,
                                              int priority,
                                              float p,
                                              float f);
